      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(shop.name, style: const TextStyle(fontSize: 23)),
              Text(
...
class EvaluationWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        for (var i = 0; i < evaluation; i++) const Icon(Icons.star),
        for (var i = evaluation; i < 5; i++) const Icon(Icons.star_border),
      ],
    );
  }
}
